...
begin
  ...
  if p_purchased_quantity < 0 or p_purchased_quantity > v_item.quantity_approved
  ...
  set purchased_quantity = p_purchased_quantity,
  ...
  values (
    v_actor, 'purchase.item.updated', 'supply_purchase_item', p_purchase_item_id,
    to_jsonb(v_item),
